...
public abstract class SimpleGui extends MalisisGui
{
	...
	static
	{
		LOCATION_GUI_SPRITE_SHEET = new ResourceLocation("textures/gui/gui.png");
		ALMURA_HEADER_LOCATION = new ResourceLocation("almura_header.png");
		ALMURA_MAN_LOCATION = new ResourceLocation("almura_man.png");
		SPONGIE_LOCATION = new ResourceLocation("spongie.png");
		SPONGEPOWERED_LOGO_LOCATION = new ResourceLocation("spongepowered_logo.png");
		ZIDANE_HEAD_LOCATION = new ResourceLocation("zidane_head.png");
